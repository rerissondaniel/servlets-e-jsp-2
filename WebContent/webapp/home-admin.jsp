...
<script language="javascript">
			<%= request.getAttribute("alert") == null ? "" : "window.alert(\"" + ((String)request.getAttribute("alert")) + "\");"%>
					...
					<form action="${pageContext.request.contextPath}/LoginServlet" method="GET">
						<div class="right-align">
							<button class="blue-grey darken-1 waves-effect waves-light btn-large"
									type="submit"><i class="material-icons">power_settings_new</i></button>
						</div>
					</form>
				</div>
			</div>
	...
	<div class="container center">
		...
		<div id="form_new_volume" class="modal">
			<div class="modal-content">
				...
				<div class="row">
					<form class="col s12"
						action="${pageContext.request.contextPath}/VolumeServlet"
						method="POST" onSubmit="return isok();" name="form_volume">
						<div class="row">
							...
							<div class="input-field col s4">
								<label>Editora</label> <input type="text" name="publisher" />
							</div>

							<div class="input-field col s4">
								<label>Tipo</label> <input type="text" name="type" />
							</div>
						</div>
						...
						<div class="row">
							<div class="input-field col s6">
								<label>Autores (Separados por Ponto e Vírgula ";")</label> <input
